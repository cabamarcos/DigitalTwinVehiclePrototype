...
def getVehicleStatus():
    vehicle_status = {"id": get_host_name(),
                      ...
                      "telemetry": {"current_steering": current_steering, 
...
def mqtt_communications():
    ...
    connection_dict = {"vehicle_plate": vehicle_plate, "status": "Off - Unregular Diconnection", "timestamp": datetime.now().timestamp()}
